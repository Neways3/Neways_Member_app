          ...
          builder: (controller) {
            ...
            return Padding(
              ...
              child: ListView(children: [
                ...
                // ),
                CustomDropDown(
                  fieldTitle: "Select Packages",
                  spinnerItemList: controller.packageCategory,
                  selectedItem: controller.selectedPackageCategory ??
                      controller.packageCategory.first,
                  onChanged: (DropdownModel model) {
                    controller.getpackageCategory(
                        model: model);
                ...
                CustomDropDown(
                  ...
                  spinnerItemList: controller.categoryListName,
                  selectedItem: controller.selectedCategoryListItem ??
                      controller.categoryListName.first,
                  onChanged: (DropdownModel model) {
