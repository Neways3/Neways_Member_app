        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              //       ),
              //       child: Text("Pre Register for Authority".toUpperCase(),style: TextStyle(fontSize: 11,color: Colors.white,fontWeight: FontWeight.w800),),
              //     ),
              //   ),
              // ),
              const SizedBox(height: defaultPadding),
              const Text(
                "By proceeding you agree to our", style: TextStyle(fontSize: 12, color: Colors.grey),
              ),
