...
import 'package:super_home_member/screens/gaming_zone/chess/off_line/components/dead_piece.dart';
import 'package:super_home_member/screens/gaming_zone/chess/off_line/components/pieces.dart';
import 'package:super_home_member/screens/gaming_zone/chess/off_line/components/square.dart';
import 'package:super_home_member/screens/gaming_zone/chess/off_line/helper/helper_function.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Text(checkStatus ? "CHECK" : "",style: const TextStyle(
          fontSize: 16,fontWeight: FontWeight.w900,color: Colors.red
          ),),

          isWhiteTurn==false?const Text("Black Turn",style: TextStyle(
          ...
          const SizedBox(height: 20,),
          isWhiteTurn==true?const Text("White Turn",style: TextStyle(
